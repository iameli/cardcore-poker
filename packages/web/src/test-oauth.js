...
async function test(name, fn) {
  try {
    ...
    results.push({
      ...
      ok: true,
      type: typeof val,
      keys: val ? Object.keys(val).slice(0, 5) : null,
    });
...
async function run() {
  ...
  await test("import @atcute/oauth-browser-client", () => import("@atcute/oauth-browser-client"));
  ...
  await test("import ../lib/atproto.js", () => import("../lib/atproto.js"));
