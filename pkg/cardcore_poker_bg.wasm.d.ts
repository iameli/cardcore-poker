...
export const __wbg_wasmoutput_free: (a: number, b: number) => void;
export const simulate_game: (a: number, b: bigint, c: bigint, d: number, e: number, f: bigint) => [number, number, number, number];
...
export const wasmagent_receive_action: (a: number, b: number, c: number, d: number, e: number) => [number, number, number];
...
export const wasmoutput_kind: (a: number) => [number, number];
