...
export const wasmagent_is_chained: (a: number) => number;
...
export const wasmagent_next_action: (a: number) => [number, number];
export const wasmagent_next_hand: (a: number) => [number, number, number];
export const wasmagent_phase: (a: number) => [number, number];
export const wasmagent_produce_bet: (a: number, b: number, c: number) => [number, number, number, number];
export const wasmagent_produce_next: (a: number) => [number, number, number, number];
...
export const wasmagent_set_chained: (a: number, b: number) => void;
